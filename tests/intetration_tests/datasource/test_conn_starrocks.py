"""
Run unit test with command: pytest gptdb/datasource/rdbms/tests/test_conn_starrocks.py
...
import pytest
from gptdb_ext.datasource.rdbms.conn_starrocks import StarRocksConnector
