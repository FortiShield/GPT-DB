export const CommonEn = {
  ...
  data_center_desc:
    'GPT-DB also offers a user-friendly data center management interface for efficient data maintenance.',
  ...
  gptdbs_community: 'GPTDBS Community',
  community_gptdbs: 'Community GPTDBS',
  my_gptdbs: 'My GPTDBS',
  Refresh_gptdbs: 'Refresh from the community Git repository',
  workflow: 'Workflow',
  resources: 'Resources',
  app: 'App',
