...
from gptdb.core.interface.parameter import EmbeddingDeployModelParameters
from gptdb.model.adapter.base import register_embedding_adapter
from gptdb.model.adapter.embed_metadata import (
    EMBED_COMMON_HF_BGE_MODELS,
    EMBED_COMMON_HF_JINA_MODELS,
    EMBED_COMMON_HF_QWEN_MODELS,
)
from gptdb.util.i18n_utils import _
from gptdb.util.tracer import GPTDB_TRACER_SPAN_ID, root_tracer
...
class HuggingFaceInstructEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from gptdb.rag.embeddings import HuggingFaceInstructEmbeddings
...
class HuggingFaceBgeEmbeddings(BaseModel, Embeddings):
    ...
    Example:
        .. code-block:: python
            ...
            from gptdb.rag.embeddings import HuggingFaceBgeEmbeddings
...
class OpenAPIEmbeddings(BaseModel, Embeddings):
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            gptdb start controller --port 8000
        ...
        .. code-block:: bash
            ...
            gptdb start apiserver --controller_addr http://127.0.0.1:8000 \
    ...
    def embed_documents(self, texts: List[str]) -> List[List[float]]:
        ...
        if self.pass_trace_id and current_span_id:
            ...
            headers[GPTDB_TRACER_SPAN_ID] = current_span_id
