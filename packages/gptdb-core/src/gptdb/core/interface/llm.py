...
from gptdb.util import BaseParameters
from gptdb.util.annotations import PublicAPI
from gptdb.util.model_utils import GPUInfo
...
class ModelOutput:
    ...
    def gen_text_with_thinking(self, new_text: Optional[str] = None) -> str:
        from gptdb.vis.tags.vis_thinking import VisThinking
...
class MessageConverter(ABC):
    ...
    Examples:
        ...
        >>> from gptdb.core.interface.message import ModelMessage, ModelMessageRoleType
        >>> from gptdb.core.interface.llm import MessageConverter, ModelMetadata
...
class DefaultMessageConverter(MessageConverter):
    ...
    def convert_to_no_system_message(
        ...
        Examples:
            ...
            ...     ModelMessageRoleType,
            ... )
            >>> from gptdb.core.interface.llm import (
    ...
    def move_last_user_message_to_end(
        ...
        Examples:
            ...
            ...     ModelMessageRoleType,
            ... )
            >>> from gptdb.core.interface.llm import DefaultMessageConverter
            >>> messages = [
            ...     ModelMessage(
            ...         role=ModelMessageRoleType.SYSTEM,
            ...         content="You are a helpful assistant",
