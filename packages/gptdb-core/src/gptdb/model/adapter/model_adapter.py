...
from gptdb.core.interface.parameter import LLMDeployModelParameters
from gptdb.model.adapter.base import LLMModelAdapter, get_model_adapter
from gptdb.model.adapter.template import ConversationAdapter, ConversationAdapterFactory
from gptdb.model.base import ModelType
...
def get_llm_model_adapter(
    ...
    if use_fastchat:
        ...
        from gptdb.model.adapter.fschat_adapter import (
...
def _dynamic_model_parser() -> Optional[List[Type[LLMDeployModelParameters]]]:
    ...
    """
    from gptdb.model.adapter.base import get_embedding_adapter
