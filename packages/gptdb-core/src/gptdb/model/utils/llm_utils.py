...
def list_supported_models():
    from gptdb.model.adapter.base import get_supported_models
...
def _list_supported_models(
    ...
    from gptdb.model.adapter.loader import _get_model_real_path
    from gptdb.model.adapter.model_adapter import get_llm_model_adapter
