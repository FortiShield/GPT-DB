...
from gptdb.storage.base import IndexStoreConfig, logger
from gptdb.storage.full_text.base import FullTextStoreBase
from gptdb.storage.vector_store.filters import (
    FilterCondition,
    FilterOperator,
    MetadataFilters,
)
...
class ElasticDocumentStore(FullTextStoreBase):
    ...
    def __init__(
        ...
        if string_utils.contains_chinese(name):
            ...
            self._index_name = "gptdb_" + hex_str
