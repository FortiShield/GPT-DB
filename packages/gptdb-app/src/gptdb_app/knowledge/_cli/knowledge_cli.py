...
@click.option(
    ...
    show_default=True,
    help=(
        "Address of the Api server(If not set, try to read from environment variable: "
        "API_ADDRESS)."
    ),
)
...
@click.option(
    ...
    type=str,
    default=None,
    help="Preseparator, this separator is used for pre-splitting before the document "
    "is actually split by the text splitter. Preseparator are not included in the "
    "vectorized text. ",
)
@click.option(
    "--separator",
...
def load(
    ...
    from gptdb_app.knowledge._cli.knowledge_client import knowledge_init
...
@click.option(
    ...
    type=str,
    default=None,
    help="The document name you want to delete. If doc_name is None, this command will"
    " delete the whole space.",
)
@click.option(
    "-y",
    required=False,
...
def delete(space_name: str, doc_name: str, y: bool):
    ...
    from gptdb_app.knowledge._cli.knowledge_client import knowledge_delete
...
@click.option(
    ...
    default=None,
    show_default=True,
    help="Your document id in knowledge space. If Not None, list all chunks in current"
    " document",
)
@click.option(
    "--page",
...
def list(
    ...
    from gptdb_app.knowledge._cli.knowledge_client import knowledge_list
