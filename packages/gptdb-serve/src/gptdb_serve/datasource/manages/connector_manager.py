...
from gptdb.core.awel.flow import ResourceMetadata
from gptdb.datasource.base import BaseConnector, BaseDatasourceParameters
from gptdb.util.annotations import Deprecated
from gptdb.util.configure.manager import _resolve_env_vars
from gptdb.util.executor_utils import ExecutorFactory
from gptdb.util.parameter_utils import _get_parameter_descriptions
from gptdb_ext.datasource.schema import DBType
from gptdb_serve.core import ResourceParameters, ResourceTypes
...
if TYPE_CHECKING:
    ...
    from gptdb_serve.datasource.service.db_summary_client import DBSummaryClient
...
class ConnectorManager(BaseComponent):
    ...
    def on_init(self):
        ...
        """
        from gptdb.datasource.rdbms.base import RDBMSConnector  # noqa: F401
        from gptdb_ext.datasource.conn_neo4j import Neo4jConnector  # noqa: F401
        from gptdb_ext.datasource.conn_spark import SparkConnector  # noqa: F401
        from gptdb_ext.datasource.conn_tugraph import TuGraphConnector  # noqa: F401
        from gptdb_ext.datasource.rdbms.conn_clickhouse import (  # noqa: F401
            ClickhouseConnector,
        )
        from gptdb_ext.datasource.rdbms.conn_doris import DorisConnector  # noqa: F401
        from gptdb_ext.datasource.rdbms.conn_duckdb import DuckDbConnector  # noqa: F401
        from gptdb_ext.datasource.rdbms.conn_gaussdb import (  # noqa: F401
            GaussDBConnector,
        )
        from gptdb_ext.datasource.rdbms.conn_hive import HiveConnector  # noqa: F401
        from gptdb_ext.datasource.rdbms.conn_mssql import MSSQLConnector  # noqa: F401
        from gptdb_ext.datasource.rdbms.conn_mysql import MySQLConnector  # noqa: F401
        from gptdb_ext.datasource.rdbms.conn_oceanbase import (  # noqa: F401
            OceanBaseConnector,
        )

        # 添加OracleConnector导入
        from gptdb_ext.datasource.rdbms.conn_oracle import OracleConnector  # noqa: F401
        from gptdb_ext.datasource.rdbms.conn_postgresql import (  # noqa: F401
            PostgreSQLConnector,
        )
        from gptdb_ext.datasource.rdbms.conn_sqlite import SQLiteConnector  # noqa: F401
        from gptdb_ext.datasource.rdbms.conn_starrocks import (  # noqa: F401
            StarRocksConnector,
        )
        from gptdb_ext.datasource.rdbms.conn_vertica import (  # noqa: F401
            VerticaConnector,
        )
        from gptdb_ext.datasource.rdbms.dialect.oceanbase.ob_dialect import (  # noqa: F401
            OBDialect,
        )
