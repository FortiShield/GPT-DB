...
from gptdb_serve.evaluate.api.schemas import (
    BenchmarkServeRequest,
    EvaluateServeRequest,
)
from gptdb_serve.evaluate.config import SERVE_SERVICE_COMPONENT_NAME, ServeConfig
from gptdb_serve.evaluate.db.benchmark_db import BenchmarkResultDao
from gptdb_serve.evaluate.service.fetchdata.benchmark_data_manager import (
    get_benchmark_manager,
)
from gptdb_serve.evaluate.service.service import Service
...
def get_prompt_service() -> PromptService:
    return global_system_app.get_component("gptdb_serve_prompt_service", PromptService)
