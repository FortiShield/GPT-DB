...
from gptdb.core import PromptManager
...
class Serve(BaseServe):
    ...
    Examples:
        ...
        .. code-block:: python
            ...
            from gptdb import SystemApp
            from gptdb.core import PromptTemplate
            from gptdb_serve.prompt.serve import Serve, SERVE_APP_NAME
    ...
    def before_start(self):
        ...
        # import your own module here to ensure the module is loaded before the
        # application starts
        from gptdb.core.interface.prompt import PromptManager
