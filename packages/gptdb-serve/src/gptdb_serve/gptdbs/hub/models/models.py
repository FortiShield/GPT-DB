...
class ServeEntity(Model):
    ...
    name = Column(String(255), unique=True, nullable=False, comment="gptdbs name")
    description = Column(String(255), nullable=False, comment="gptdbs description")
    author = Column(String(255), nullable=True, comment="gptdbs author")
    email = Column(String(255), nullable=True, comment="gptdbs author email")
    type = Column(String(255), comment="gptdbs type")
    version = Column(String(255), comment="gptdbs version")
    storage_channel = Column(String(255), comment="gptdbs storage channel")
    storage_url = Column(String(255), comment="gptdbs download url")
    download_param = Column(String(255), comment="gptdbs download param")
    gmt_created = Column(
        DateTime,
    ...
    UniqueConstraint("name", "type", name="uk_gptdbs")
