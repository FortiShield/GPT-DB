...
class GPTDBFileSystem(AbstractFileSystem):
    """Interface to files in GPTDBFileStorage
    ...
    def created(self, path):
        ...
        raise NotImplementedError("created() is not supported by GPTDBFileSystem")

    def modified(self, path):
        """Get modification time - not supported."""
        raise NotImplementedError("modified() is not supported by GPTDBFileSystem")

    def mkdir(self, path, create_parents=True, **kwargs):
        """Create directory - not needed for GPTDBFileSystem."""
        # No-op since we don't have directories
        pass

    def makedirs(self, path, exist_ok=True):
        """Create directory and parents - not needed for GPTDBFileSystem."""
        # No-op since we don't have directories
        pass
...
class GPTDBFile(io.IOBase):
    """File-like interface for GPTDBFileSystem."""
