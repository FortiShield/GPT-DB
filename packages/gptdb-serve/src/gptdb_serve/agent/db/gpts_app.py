...
from gptdb.agent.core.plan import AWELTeamContext
from gptdb.agent.resource.base import AgentResource, ResourceType
from gptdb.storage.metadata import BaseDao, Model
from gptdb_app.openapi.api_view_model import ConversationVo
from gptdb_app.scene import ChatScene
...
class GptsAppDao(BaseDao):
    ...
    def list_hot_apps(self, query: GptsAppQuery):
        from gptdb.storage.chat_history.chat_history_db import ChatHistoryDao
            ...
            if app_info.param_need:
                ...
                if len(resource_params) == 1:
                    ...
                    if resource_param.get("bind_value"):
                        ...
                        from gptdb_app.knowledge.service import (
                            KnowledgeService,
