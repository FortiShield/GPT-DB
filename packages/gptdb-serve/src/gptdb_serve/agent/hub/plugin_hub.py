...
from gptdb_serve.agent.hub.db.my_plugin_db import MyPluginDao, MyPluginEntity
from gptdb_serve.agent.hub.db.plugin_hub_db import PluginHubDao, PluginHubEntity

logger = logging.getLogger(__name__)
Default_User = "default"
DEFAULT_PLUGIN_REPO = "https://github.com/khulnasoft-bot/GPT-DB-Plugins.git"
TEMP_PLUGIN_PATH = ""
        ...
        try:
            for git_plugin in git_plugins:
                ...
                if old_hub_info:
                    ...
                    plugin_hub_info.author = getattr(git_plugin, "_author", "GPT-DB")
